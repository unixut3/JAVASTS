...
@Repository("userDaoJDBC2")
public class UserDaoImplJDBCAnnotation2 implements UserDao {
	@Autowired
	private DataSource dataSource;
	
	public UserDaoImplJDBCAnnotation2() {
		System.out.println("#### UserDaoImplJDBCAnnotation2() : 디폴트생성자 호출  ");
		
	}
	public UserDaoImplJDBCAnnotation2(DataSource dataSource) {
		System.out.println("#### UserDaoImplJDBCAnnotation2(DataSource dataSource) : 생성자 호출  ");
		this.dataSource = dataSource;
	}
	public void setDataSource(DataSource dataSource) {
		System.out.println("#### UserDaoImplJDBCAnnotation2.setDataSource("+dataSource+") : 호출  ");
		this.dataSource = dataSource;
	}
	...
	public int create(User user) throws Exception {
		System.out.println("#### UserDaoImplJDBCAnnotation2 : create() 호출  ");
		Connection con = null;
	...
	public int update(User user) throws Exception {
		System.out.println("#### UserDaoImplJDBCAnnotation2 : update() 호출  ");
		Connection con = null;
		PreparedStatement pstmt = null;
	...
	public int remove(String userId) throws Exception {
		System.out.println("#### UserDaoImplJDBCAnnotation2 : remove() 호출  ");
		Connection con = null;
		PreparedStatement pstmt = null;
	...
	public User findUser(String userId) throws Exception {
		System.out.println("#### UserDaoImplJDBCAnnotation2 : findUser() 호출  ");
		User user = null;
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public List<User> findUserList() throws Exception {
		System.out.println("#### UserDaoImplJDBCAnnotation2 : findUserList 호출  ");
	...
	public boolean existedUser(String userId)throws Exception{
		System.out.println("#### UserDaoImplJDBCAnnotation2 : existedUser() 호출  ");
		Connection con=null;
		PreparedStatement pstmt=null;
		ResultSet rs=null;
