...
<script type="text/javascript">
	function guest_write(actionUrl){
		...
		오른쪽버튼 actionUrl--> parameter_guest_write_action.do
		*/
					...
					<tr>
						<td>
							...
							<table width=590 border=0 cellpadding=0 cellspacing=0>
								<tr>
									<td align=center>
									<input type="button" onclick="guest_write('parameter_guest_write_action.do')" value="방명록쓰기[parameter]"> &nbsp; 
								    <input type="button" onclick="guest_write('model_attribute_guest_write_action.do')" value="방명록쓰기[model attribute]"></td>
								</tr>
							</table>
						</td>
					</tr>
